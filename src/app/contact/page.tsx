export default function contact() {
  return (
    <div className=" bg-white">
      ...
      <div className="font-sans text-[40px] mt-5 font-bold text-[#56AAE3] flex justify-center">
        <h1>Temukan Agen Kami Di Kotamu</h1>
      </div>
      <form
        action="https://leminerale.com/find-us#agent"
        method="GET"
        className="w-fit relative bg-[#56AAE3] mx-87 mt-[100px] p-4 rounded-xl mb-20"
      >
        <div className="flex flex-wrap md:flex-nowrap items-center justify-between gap-[100px]">
          <div className="gap-[100px] pl-10 flex justify-between">
            ...
            <select
              name="city"
              id="city"
              className="bg-white w-full border-none rounded-lg h-[60] "
            >
